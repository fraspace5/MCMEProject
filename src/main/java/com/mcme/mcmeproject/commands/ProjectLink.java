                ...
                if (playerPermission(args[0], cs)) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                String stat = "UPDATE " + Mcproject.getPluginInstance().database + ".mcmeproject_project_data SET link = '" + args[1] + "' WHERE idproject = '" + PluginData.projectsAll.get(args[0]).idproject.toString() + "' ;";
