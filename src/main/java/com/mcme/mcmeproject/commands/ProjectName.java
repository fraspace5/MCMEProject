                    ...
                    if (!args[0].equals(args[1])) {
                        ...
                        new BukkitRunnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    String stat = "UPDATE " + Mcproject.getPluginInstance().database + ".mcmeproject_project_data SET name = '" + args[1] + "' WHERE idproject = '" + PluginData.projectsAll.get(args[0]).idproject.toString() + "' ;";
